  ...
  return (
    <div className="fixed inset-0 bg-[#1A1F2C] flex flex-col items-center justify-center">
      <img 
        ...
        alt="Praying hands"
        className="w-48 h-48 mb-8 [filter:invert(48%)_sepia(94%)_saturate(751%)_hue-rotate(346deg)_brightness(101%)_contrast(96%)] animate-[pulse_5s_ease-in-out_infinite]"
      />
